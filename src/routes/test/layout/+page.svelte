...
<div class="flex h-screen flex-row">
	<div class="hidden h-full max-h-screen w-1/5 flex-grow flex-col overflow-y-auto border-r lg:flex">
		<!-- header -->
	...
	<div class="flex h-full w-full flex-col lg:w-4/5">
		<!-- topbar -->
									...
									<div class="flex w-full flex-col items-start gap-2 pt-6">
										...
										<div class="flex flex-row">
											<div class="flex flex-col gap-1">
												...
												<div class="text-muted-foreground text-xs md:inline">
		...
		<div class="flex h-auto w-full flex-row items-center justify-center border-t lg:hidden">
			<a href="###" class="flex h-12 w-1/3 flex-col items-center justify-center border-x">
				<Home class="h-4 w-4" />
				<p class="text-xs font-medium">Home</p>
			</a>
			<a href="###" class="flex h-12 w-1/3 flex-col items-center justify-center">
				<ListTodo class="h-4 w-4" />
